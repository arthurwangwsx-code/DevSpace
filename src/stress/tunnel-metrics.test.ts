...
http_client_request_duration_seconds_count{http_request_method="POST",http_route="/mcp"} 2
http_client_request_duration_seconds_sum{http_request_method="POST",http_route="/mcp"} 0.02
http_client_request_duration_seconds_count{http_request_method="DELETE",http_route="/mcp"} 0
http_client_request_duration_seconds_sum{http_request_method="DELETE",http_route="/mcp"} 0
...
http_client_request_duration_seconds_count{http_request_method="POST",http_route="/mcp"} 4
http_client_request_duration_seconds_sum{http_request_method="POST",http_route="/mcp"} 0.06
http_client_request_duration_seconds_count{http_request_method="DELETE",http_route="/mcp"} 1
http_client_request_duration_seconds_sum{http_request_method="DELETE",http_route="/mcp"} 0.02
...
assert.equal(summary.sessionDeleteRequests, 1);
