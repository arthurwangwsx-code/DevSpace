...
| Distribution and Control Center | Native macOS App with embedded Node runtime, menu-bar status/service controls, unified Settings UI, managed Tunnel configuration, Browser/Desktop setup, login startup and release packaging | [Distribution and Control Center](distribution-and-control-center.md) |
